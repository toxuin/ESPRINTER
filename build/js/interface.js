...
function resetGui() {
	...
	// Navbar
	setTitle("3D Printer Web Control");
...
// TODO: CHECK IF REPETIER SUPPORTS H1
...
$("#btn_load_filament").click(function() {
	...
	var gcode = (compatMode?"":"M120\n") + "M83\nG1 E" + (settings.bowdenLength - 15) + " F7500\n" +
		"G1 E15 F450" + (compatMode?"":"\nM121");
		setTimeout(function() {
	   sendGCode(gcode);
	 }, 200);
});
...
$("#btn_unload_filament").click(function() {
	...
	var gcode = (compatMode?"":"M120\n") + "M83\nG1 E-10 F450\n" +
		"G1 E-" + (settings.bowdenLength - 10) + " F7500" + (compatMode?"":"\nM121");
	setTimeout(function() {
	sendGCode(gcode);
	}, 200);
});
